...
# download data into a dataframe called "assignment9"

```{r}
assignment9 = read_csv("a9_data.csv")
```
...
lenth(assignment9 %>% pull(subject) %>% unique())
```

# filtering to important trials

```{r}
main_data = assignment9 %>% filter(!is.na(accessibility)) %>%
